...
import (
	...
	entity "gitlab.com/ianadiwibowo/kisakita-stories/entity"
)
...
func (_m *StoryUsecases) Create(newStory *entity.Story) error {
...
func (_m *StoryUsecases) Delete(existingStory *entity.Story) error {
...
func (_m *StoryUsecases) Get10LatestStories() ([]*entity.Story, error) {
	ret := _m.Called()
...
func (_m *StoryUsecases) GetByAuthorID(writerID int) ([]*entity.Story, error) {
...
func (_m *StoryUsecases) GetByID(storyID int) (*entity.Story, error) {
...
func (_m *StoryUsecases) Update(existingStory *entity.Story) error {
	ret := _m.Called(existingStory)
