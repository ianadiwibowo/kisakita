...
import entities "github.com/ianadiwibowo/kisakita/entities"
import mock "github.com/stretchr/testify/mock"

// StoryUsecases is an autogenerated mock type for the StoryUsecases type
type StoryUsecases struct {
	mock.Mock
}

// Create provides a mock function with given fields: newStory
func (_m *StoryUsecases) Create(newStory *entities.Story) error {
...
func (_m *StoryUsecases) Delete(existingStory *entities.Story) error {
...
func (_m *StoryUsecases) Get10LatestStories() ([]*entities.Story, error) {
	ret := _m.Called()
...
func (_m *StoryUsecases) GetByAuthorID(writerID int) ([]*entities.Story, error) {
...
func (_m *StoryUsecases) GetByID(storyID int) (*entities.Story, error) {
...
func (_m *StoryUsecases) Update(existingStory *entities.Story) error {
	ret := _m.Called(existingStory)
