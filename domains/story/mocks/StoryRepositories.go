...
func (_m *StoryRepositories) Create(newStory *entity.Story) error {
...
func (_m *StoryRepositories) Delete(existingStory *entity.Story) error {
...
func (_m *StoryRepositories) Get10LatestStories() ([]*entity.Story, error) {
	ret := _m.Called()
...
func (_m *StoryRepositories) GetByAuthorID(writerID int) ([]*entity.Story, error) {
...
func (_m *StoryRepositories) GetByID(storyID int) (*entity.Story, error) {
...
func (_m *StoryRepositories) Update(existingStory *entity.Story) error {
	ret := _m.Called(existingStory)
